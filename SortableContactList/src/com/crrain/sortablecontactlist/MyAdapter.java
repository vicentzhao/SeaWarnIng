...
public class MyAdapter extends BaseAdapter implements SectionIndexer {
	...
	public MyAdapter(Context _context, ArrayList<ContactBean> contactbeans,ArrayList<String> stringArray) {
	...
	public View getView(int position, View v, ViewGroup parent) {
		...
		tv_phonenum.setText(beans.get(position).getContactPhone());
