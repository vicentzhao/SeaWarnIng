...
import com.testcontact.bean.ContactBean;
import com.testcontact.bean.PhoneLog;
...
public class TestContactActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ContactInfoService service = new ContactInfoService(TestContactActivity.this);
        ArrayList<ContactBean> callLogs = service.getContact();
        nicks =new String[callLogs.size()];
